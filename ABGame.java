/**
 * α β pruning for midgame/endgame phase
 */
...
public class ABGame {
    public static BoardOut ABPruning(PosList board, int depth, boolean isMax, int a, int b) {
        ...
        if (isMax) moves = Generate.generateMovesMidgameEndgame(board);
        else moves = Generate.generateMovesMidgameEndgameForBlack(board);
